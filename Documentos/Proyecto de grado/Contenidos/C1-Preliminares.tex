...
\textbf{Definición:} Una colección $\mathcal{A}$ de subconjuntos de un espacio $X$ se dice que cubre a $X$ o que es un cobrimiento de $X$, si la unión de los elementos de $\mathcal{A}$ coincide con $X$. Se dice que $A$ es un cubrimiento abierto de $X$ si es un cubrimiento de $X$ formado por conjuntos abiertos de $X$.

\textbf{Definición:} Un espacio $X$ se dice que es compacto si de cada cubrimiento abierto $\mathcal{A}$ de $X$ podemos extraer una subcolección finita que también cubre a $X$.

\textbf{Definición:} Una colección $\mathcal{C}$ de subconjuntos de $X$ se dice que tiene la propiedad de intersección finita si cada subcolección finita de $\mathcal{C}$ tiene intersección no vacía.
